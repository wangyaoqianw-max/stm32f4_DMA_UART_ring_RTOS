 ...
 * All Rights Reserved.
 *
 * @file platform_font_ascii_8x16.c
 * @brief Platform Graphics 可打印 ASCII 8x16 点阵数据
 * @author YaoQian Wang
 * @date 2026-09-06
 * @version V1.0
 *
...
//******************************** Defines *********************************//
#define PLATFORM_FONT_ASCII_8X16_GLYPH_COUNT      (95U)
#define PLATFORM_FONT_ASCII_8X16_BYTES_PER_GLYPH  (16U)
//******************************** Defines *********************************//

//******************************** Constants ********************************//
static const uint8_t g_platformFontAscii8x16GlyphData[
    PLATFORM_FONT_ASCII_8X16_GLYPH_COUNT][PLATFORM_FONT_ASCII_8X16_BYTES_PER_GLYPH] =
{
...
const platform_font_t g_platformFontAscii8x16 =
{
    ...
    0x20U,
    0x7EU,
    &g_platformFontAscii8x16GlyphData[0][0],
    PLATFORM_FONT_ASCII_8X16_BYTES_PER_GLYPH
};
//******************************** Constants ********************************//
